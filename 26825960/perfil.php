...
<html>
	<?php
		// Load profile JSON
		$json_perfil = file_get_contents('/26825960/datos/perfil.json');
		...
		if($len == "es"){
			$json_config = file_get_contents('/26825960/datos/configES.json');
		}
		else if($len == "pt"){
			$json_config = file_get_contents('/26825960/datos/configPT.json');
		}
		else{ // The deafult langueje is english
			$json_config = file_get_contents('/26825960/datos/configEN.json');
		}
